...
- 问"口碑/评价/好不好看"时三管齐下：① get_subject 的**评分分布(rating.count 直方图)**判断口碑结构（集中高分=好评、双峰=两极、均值高人多=公认神作）；② get_subject_comments 抓**真实短评(吐槽)**看大家具体怎么说；③ 需要更广讨论再 web_search。综合作答、注明来源，别凭空编"大家觉得"。
