...
TOOL_GROUPS: dict[str, dict[str, Any]] = {
    ...
    "product_page": {
        ...
        "tools": {"watch_cockpit", "subject_dossier", "anime_watch_hub", "franchise_map", "monthly_watch_report", "build_taste_report", "build_collection_dashboard", "compare_subjects", "plan_watch_order", "get_series_progress", "plan_watch_copilot"},
